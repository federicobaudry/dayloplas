        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              <a href="#cargar" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="cargar">
                <h6 class="m-0 font-weight-bold text-primary">Cargar una nueva marca</h6>
              </a>
            <div class="collapse show" id="cargar">
              <div class="card-body form-group">
                <label for="nombrecurso">Nombre de la empresa a cargar</label>
                <input type="text" id="nombremarca" class="form-control col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <br>
                <button class="btn btn-primary" id="loadmarca" >Cargar</button>
              </div>
            </div>
          </div>
          <div class="card shadow mb-4">
              <a href="#elimarcas" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="tablacurso">
                <h6 class="m-0 font-weight-bold text-primary">Eliminar un marca</h6>
              </a>
            <div class="collapse show" id="elimarcas">
              <div class="card-body">
                <div class="table-responsive">
                  <label for="cursoeli">seleccione el curso a eliminar</label>
                  <select name="cursoeli" id="marcaeli" class="form-control col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  </select>
                  <br>
                  <button class="btn btn-danger" id="elimarca">Eliminar marca</button>
                </div>
              </div>
            </div>
          </div>
