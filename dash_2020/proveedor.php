          ...
          <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="cargar">
              <div class="card-body form-group">
                <label for="nombre">Nombre y apellido del proveedor</label>
                <input type="text" id="nombre" class="form-control col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <label for="correo">Correo del proveedor</label>
                <input type="text" id="correo" class="form-control col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <label for="tel">N° de telefono</label>
                <input type="text" id="tel" class="form-control col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <label for="marca">Marca la cual provee</label>
                <select name="marca" id="marca" class="form-control col-xl-12 col-lg-12 col-md-12 col-sm-12">
                </select>
                <br>
                <button class="btn btn-primary" id="loadprove" >Cargar</button>
              </div>
            </div>
          </div>
          <div class="card shadow mb-4">
              <a href="#eliminar" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="eliminar">
                <h6 class="m-0 font-weight-bold text-primary">Eliminar proveedor</h6>
              </a>
            <div class="collapse show" id="eliminar">
              <div class="card-body form-group">
                <select name="provedor" id="provedoreli" class="form-control col-xl-12 col-lg-12 col-md-12 col-sm-12">
                </select>
                <br>
                
                <button class="btn btn-danger" id="eliprove">Eliminar proveedor</button>
              </div>
            </div>
          </div>
          <div class="card shadow mb-4">
